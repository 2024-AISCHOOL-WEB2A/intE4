        ...
        <footer class="footer">
          <div class="overlap-group">
            <div class="container-2">
              ...
              <p class="text-wrapper-12">COPYRIGHT ©2024 SINBUYA ALL RIGHTS RESERVED.</p>
            </div>
          ...
          <div class="container-3">
            ...
            <p class="div-5">
              <span class="text-wrapper-16">개인정보관리책임자 </span> <span class="text-wrapper-17">정수형</span>
            </p>
          </div>
          <div class="container-4">
            ...
            <p class="t-f">
              <span class="text-wrapper-23">T</span>
              <span class="text-wrapper-24"> 062-123-4567   |   </span>
              <span class="text-wrapper-23">F</span>
              <span class="text-wrapper-24"> 062-123-4568</span>
            </p>
