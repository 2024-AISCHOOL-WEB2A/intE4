...
<body>
    ...
    <div class="container">
        <div class="reservation-form">
            ...
            // 스튜디오 정보를 가져오기 위해 DAO를 사용
            StudioDAO studioDAO = new StudioDAO();
            Studio studio = studioDAO.getStudioById(itemId);

            // 스튜디오 정보를 찾을 수 없으면 오류 메시지 출력
            if (studio == null) {
                out.println("<p>잘못된 요청입니다. 스튜디오 정보를 찾을 수 없습니다.</p>");
                return;
            }

            String photoPath = studio.getPhotoPath();
            String title = studio.getStudioTitle();
            String brand = studio.getStudioBrand();  // 브랜드 정보 가져오기
            int price = studio.getStudioPrice();
            String imagePath = "studio";  // 이미지 경로 설정
            %>
            <!-- 스튜디오 이미지 출력 -->
            <img src="<%= request.getContextPath() %>/upload/<%= imagePath %>/<%= photoPath %>" alt="Studio Image" />
            ...
            <form id="reservationForm" method="get" action="ReservationService">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="vendor_category" name="vendor_category" value="스튜디오" readonly>
                </div>
