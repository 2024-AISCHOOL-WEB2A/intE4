...
<body>
	<div class="nav">
		<a href="#" class="lisianthus">L i s i a n t h u s</a>
		<div class="frame-2">
			<div class="view">
				<a href="#" class="text-wrapper">웨딩홀</a>
				<a href="#" class="text-wrapper">드레스</a>
				<a href="#" class="text-wrapper-2">스튜디오</a>
				<a href="#" class="text-wrapper-3">메이크업</a>
			</div>
			<%
