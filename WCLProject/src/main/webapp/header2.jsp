...
<link rel="stylesheet" href="./css/page_globals.css">
<link rel="stylesheet" href="./css/page_styleguide.css">
        ...
        <div class="frame-2">
            ...
            %>
                <div class="frame-3">
                    <div class="text-wrapper-4">회원정보 수정</div>
                    <div class="text-wrapper-5">예약관리</div>
                    <a href="productWeddingHallManagement.jsp" class="text-wrapper-5">상품 관리</a>
                    <form id="logoutForm" action="Logout" method="post" style="display: none;">
                        <input type="hidden" name="_method" value="POST">
                    </form>
                    <div class="text-wrapper-5" onclick="document.getElementById('logoutForm').submit();">로그아웃</div>
