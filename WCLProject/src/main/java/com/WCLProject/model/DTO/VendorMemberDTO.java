...
public class VendorMemberDTO implements MemberDTO {
	private String id;
	private String pw;
	private String name;
	private String tel;
	...
	public VendorMemberDTO(String id, String pw, String name, String category) {
		super();
		this.id = id;
		this.pw = pw;
		this.name = name;
	...
	public VendorMemberDTO(String id, String pw, String name, String tel, String email, String address, String license,
